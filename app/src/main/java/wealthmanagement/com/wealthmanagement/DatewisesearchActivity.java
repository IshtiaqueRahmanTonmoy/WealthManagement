        ...
        stringRequest = new StringRequest("http://ingtechbd.com/demo/wealthmanagement/getransactionbyid.php?user_id="+6,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(DatewisesearchActivity.this,error.getMessage(),Toast.LENGTH_LONG).show();
                    }
                });


        RequestQueue requestQueue = Volley.newRequestQueue(DatewisesearchActivity.this);
        requestQueue.add(stringRequest);
        progressDialog = new ProgressDialog(DatewisesearchActivity.this);
